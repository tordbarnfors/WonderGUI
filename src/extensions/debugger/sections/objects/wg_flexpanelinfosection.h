...
=========================================================================*/
#ifndef	WG_FLEXPANELINFOSECTION_DOT_H
...
namespace wg
{
	class FlexPanelInfoSection;
	typedef	StrongPtr<FlexPanelInfoSection>	FlexPanelInfoSection_p;
	typedef	WeakPtr<FlexPanelInfoSection>	FlexPanelInfoSection_wp;
