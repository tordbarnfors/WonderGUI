...
=========================================================================*/
#ifndef	WG_LABELCAPSULEINFOSECTION_DOT_H
...
namespace wg
{
	class LabelCapsuleInfoSection;
	typedef	StrongPtr<LabelCapsuleInfoSection>	LabelCapsuleInfoSection_p;
	typedef	WeakPtr<LabelCapsuleInfoSection>	LabelCapsuleInfoSection_wp;
