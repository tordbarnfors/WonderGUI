...
=========================================================================*/
#ifndef	WG_PANELINFOSECTION_DOT_H
#define WG_PANELINFOSECTION_DOT_H
#pragma once
...
namespace wg
{
	class PanelInfoSection;
	typedef	StrongPtr<PanelInfoSection>	PanelInfoSection_p;
	typedef	WeakPtr<PanelInfoSection>	PanelInfoSection_wp;
