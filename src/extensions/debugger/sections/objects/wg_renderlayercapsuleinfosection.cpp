...
namespace wg
{
	...
	const TypeInfo RenderLayerCapsuleInfoSection::TYPEINFO = { "RenderLayerCapsuleInfoSection", &InfoSection::TYPEINFO };
	...
	const TypeInfo& RenderLayerCapsuleInfoSection::typeInfo(void) const
	{
		return TYPEINFO;
	}
