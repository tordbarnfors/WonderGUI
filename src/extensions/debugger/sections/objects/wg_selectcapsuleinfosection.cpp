...
namespace wg
{
	...
	const TypeInfo SelectCapsuleInfoSection::TYPEINFO = { "SelectCapsuleInfoSection", &InfoSection::TYPEINFO };
	...
	const TypeInfo& SelectCapsuleInfoSection::typeInfo(void) const
	{
		return TYPEINFO;
	}
