...
namespace wg
{
	...
	class ObjectInspector : public InspectorView
	{
	public:

		//.____ Creation __________________________________________

		static ObjectInspector_p		create( const DebugTheme& theme, IDebugContext * pContext, Object * pObject) { return ObjectInspector_p(new ObjectInspector(theme, pContext, pObject) ); }
	...
	protected:
		ObjectInspector(const DebugTheme& theme, IDebugContext * pContext, Object * pObject );
		~ObjectInspector() {}
