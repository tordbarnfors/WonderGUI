...
namespace wg
{
	...
	const TypeInfo SkinInspector::TYPEINFO = { "SkinInspector", &InspectorView::TYPEINFO };


	//____ constructor _____________________________________________________________

	SkinInspector::SkinInspector(const DebugTheme& theme, IDebugContext * pContext, Skin * pSkin) : InspectorView( theme, pContext )
	{
		...
		auto pDisplayBackground = WGCREATE(TileSkin, _.surface = theme.transparencyGrid, _.spacing = 8, _.padding = 8);
		...
		pBasePanel->slots.pushBack(_createClassInfoSections(theme, pSkin));
