...
namespace wg
{
	...
	const TypeInfo WidgetInspector::TYPEINFO = { "WidgetInspector", &InspectorView::TYPEINFO };


	//____ constructor _____________________________________________________________

	WidgetInspector::WidgetInspector(const DebugTheme& bp, IDebugContext * pContext, Widget * pWidget) : InspectorView( bp, pContext )
	{
		...
		pBasePanel->slots.pushBack( _createClassInfoSections(bp,pWidget));
