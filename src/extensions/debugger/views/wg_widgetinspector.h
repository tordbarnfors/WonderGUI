...
namespace wg
{
	...
	class WidgetInspector : public InspectorView
	{
	public:

		//.____ Creation __________________________________________

		static WidgetInspector_p		create( const DebugTheme& theme, IDebugContext * pContext, Widget * pWidget) { return WidgetInspector_p(new WidgetInspector(theme, pContext, pWidget) ); }
	...
	protected:
		WidgetInspector(const DebugTheme& theme, IDebugContext * pContext, Widget * pWidget );
		~WidgetInspector() {}
