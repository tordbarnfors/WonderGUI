...
namespace wg
{
	...
	class WidgetTreeView : public InspectorView
	{
	public:

		//.____ Creation __________________________________________

		static WidgetTreeView_p		create( const DebugTheme& theme, IDebugContext * pContext, Widget * pRoot ) { return WidgetTreeView_p(new WidgetTreeView(theme, pContext, pRoot) ); }
	...
	protected:
		WidgetTreeView(const DebugTheme& theme, IDebugContext* pContext, Widget * pRoot );
		~WidgetTreeView();
